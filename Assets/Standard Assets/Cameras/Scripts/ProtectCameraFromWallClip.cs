...
namespace UnityStandardAssets.Cameras
{
    ...
    {
        //public Å® private   0.05f Å® 0f 
        private float clipMoveTime = 0f;              // time taken to move when avoiding cliping (low value = fast, which it should be)
        ...
        //public Å® private   0.5f Å® 10f 
        private float closestDistance = 20f;            // the closest distance the camera can be from the target
